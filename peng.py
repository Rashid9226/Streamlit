...
def main():
    ...
    with st.form("penguin_form"):
        ...
        island = st.selectbox('Island',('Biscoe','Dream','Torgersen'),index=None,)
    ...
    if submitted:
        ...
        prediction_output = penguins_species[prediction]
        st.write('\n'.join(prediction_output))  # Displaying each prediction on a new line
